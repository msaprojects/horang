...
class Forgot_Password {
  ...
  Forgot_Password({this.email, this.uuid});

  factory Forgot_Password.fromJson(Map<String, dynamic> map) {
    return Forgot_Password(email: map['email'], uuid: map['uuid']);
  }
...
List<Forgot_Password> ForgotPassFromJson(String jsonData) {
  ...
  return List<Forgot_Password>.from(
      data.map((item) => Forgot_Password.fromJson(item)));
}
